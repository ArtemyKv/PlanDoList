...
protocol PlannedListPresenterProtocol: BasicListPresenter {
    init(listManager: PlannedListManagerProtocol, view: BasicListViewProtocol, coordinator: MainCoordinatorProtocol)
}

class PlannedListPresenter: PlannedListPresenterProtocol {
    let coordinator: MainCoordinatorProtocol
    let listManager: PlannedListManagerProtocol
    ...
    required init(listManager: PlannedListManagerProtocol, view: BasicListViewProtocol, coordinator: MainCoordinatorProtocol) {
    ...
    func configureView() {
        let title = "Planned"
        let subtitle = "Tasks with remind and due dates"
...
extension PlannedListPresenter: AddTaskPresenterDelegate {
